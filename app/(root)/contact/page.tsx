                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <p className="text-md text-muted-foreground">
                          <b>Jaipur:</b> A1, A2 SS Bhandari Nagar, Swej Farm,
                          Sodala, Jaipur, Rajasthan 302019
                        </p>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <p className="text-md text-muted-foreground">
                          <b>Mumbai:</b> 604, A wing, Trade Square Mehra
                          Compound, Andheri - Kurla Rd, Safed Pul, Saki Naka,
                          Andheri East, Mumbai, Maharashtra 400072
                        </p>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <p className="text-md text-muted-foreground">
                          <b>Dubai:</b> D Wings 4th floor - DSO Headquarters
                          Dubai Silicon Oasis - Dubai - United Arab Emirates
                        </p>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <p className="text-md text-muted-foreground">
                          <b>Canada:</b> 6705 Tomken Road Unit 219 Box 244
                          Mississauga, ON L5T 2J6
                        </p>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <p className="text-md text-muted-foreground">
                          <b>Australia:</b> 320 Victoria Parade, East Melbourne
                          VIC 3002
                        </p>
                      </div>
                    </div>

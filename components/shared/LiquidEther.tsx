...
const defaultColors = ["#f8f9fa", "#e9ecef", "#dee2e6"];
...
`;
    ...
    type Uniforms = Record<
      string,
      {
        value: THREE.Texture | number | THREE.Vector2 | THREE.Vector3 | boolean;
      }
    >;
    ...
    interface SimulationProps {
      ...
      src?: { texture: THREE.Texture } | THREE.WebGLRenderTarget | null;
      ...
      vel?: THREE.Texture;
      src_p?: { texture: THREE.Texture } | THREE.WebGLRenderTarget | null;
      src_v?: { texture: THREE.Texture } | THREE.WebGLRenderTarget | null;
    }
      ...
      constructor(simProps: SimulationProps) {
        super({
          material: {
            ...
            uniforms: {
              boundarySpace: {
                value: simProps.cellScale || new THREE.Vector2(1, 1),
              },
              px: { value: simProps.cellScale || new THREE.Vector2(1, 1) },
              fboSize: { value: simProps.fboSize || new THREE.Vector2(1, 1) },
              velocity: { value: simProps.src?.texture || new THREE.Texture() },
              dt: { value: simProps.dt || 0.016 },
              isBFECC: { value: true },
            },
          },
          output: simProps.dst,
    ...
    class Viscous extends ShaderPass {
      constructor(simProps: SimulationProps) {
        super({
          material: {
            ...
            uniforms: {
              boundarySpace: {
                value: simProps.boundarySpace || new THREE.Vector2(1, 1),
              },
              velocity: { value: simProps.src?.texture || new THREE.Texture() },
              velocity_new: {
                value: simProps.dst_?.texture || new THREE.Texture(),
              },
              v: { value: simProps.viscous || 30 },
              px: { value: simProps.cellScale || new THREE.Vector2(1, 1) },
              dt: { value: simProps.dt || 0.016 },
            },
          },
      ...
      update(
        ...args: { viscous?: number; iterations?: number; dt?: number }[]
        ...
        let fbo_in: THREE.WebGLRenderTarget | null = null,
          fbo_out: THREE.WebGLRenderTarget | null = null;
    ...
    class Poisson extends ShaderPass {
        ...
        super({
          material: {
            ...
            uniforms: {
              ...
              divergence: {
                value: simProps.src?.texture || new THREE.Texture(),
              },
              px: { value: simProps.cellScale || new THREE.Vector2(1, 1) },
            },
          },
      ...
      update(
        ...
        let p_in: THREE.WebGLRenderTarget | null = null,
          p_out: THREE.WebGLRenderTarget | null = null;
        const iter = iterations ?? 0;
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
        ...
        super({
          material: {
            ...
            uniforms: {
              ...
              pressure: {
                value: simProps.src_p?.texture || new THREE.Texture(),
              },
              velocity: {
                value: simProps.src_v?.texture || new THREE.Texture(),
              },
              px: { value: simProps.cellScale || new THREE.Vector2(1, 1) },
              dt: { value: simProps.dt || 0.016 },
            },
    ...
    class Simulation {
      ...
      update() {
        ...
        if (vel) this.divergence.update({ vel });
        const pressure = this.poisson.update({
          iterations: this.options.iterations_poisson,
        });
        if (vel && pressure) this.pressure.update({ vel, pressure });
      }
    }

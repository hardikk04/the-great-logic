  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        <h1
          ref={titleRef}
          className="text-4xl md:text-7xl lg:text-8xl font-heading font-bold text-black mb-6"
        >
          Revolutionizing
          <br />
        ...
        <p
          ref={subtitleRef}
          className="text-md md:text-xl text-black md:my-12 max-w-3xl mx-auto font-body "
        >

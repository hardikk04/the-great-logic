...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative pointer-events-none pt-[14rem] pb-[3rem] flex items-center justify-center overflow-hidden bg-gradient-hero"
    >
      {/* Main Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 text-center max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-black mb-6">
            Revolutionizing the future of operations
          </h1>
